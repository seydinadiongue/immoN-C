...
<img id ='b' src  ="icon4.png"/>
		...
		<section id='span'>
        <a id="kal" class="gf" href="reservation.php" >Réservations </a>
	...
	<?php
		...
		echo'<img  id="img" src="uploads/' ; echo $i ;echo '" />';
			...
			echo'<form style="display:inline-block;" id="f2" method="post" action="valider.php" >';
			...
			echo'<form  style="display:inline-block;"   method="post" action="jet.php">';
